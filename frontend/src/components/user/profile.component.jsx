...
const Profile = ({
  setIsProfileBeingUpdated,
  setAreCredentialsBeingUpdated,
}) => {
    ...
    <Row>
      <Col xs={12}>
        <Table hover className="mt-1">
          <tbody>
            ...
            <tr>
              <td className="font-weight-bolder">Profile Name</td>
              <td>
                {user.profileName}{" "}
                {user.isPublic ? (
            ...
            <tr>
              <td className="font-weight-bolder">First Name</td>
              <td>{user.firstName}</td>
            </tr>
            <tr>
              <td className="font-weight-bolder">Last Name</td>
              <td>{user.lastName}</td>
            </tr>
            <tr>
              <td className="font-weight-bolder">LinkedIn</td>
              <td>
            ...
            <tr>
              <td className="font-weight-bolder">Twitter</td>
              <td>
            ...
            <tr>
              <td className="font-weight-bolder">GitHub</td>
              <td>
            ...
            <tr>
              <td className="font-weight-bolder">Homepage</td>
              <td>
            ...
            <tr>
              <td className="font-weight-bolder">Location</td>
              <td>{user.location}</td>
            </tr>
            <tr>
              <td className="font-weight-bolder">Bio</td>
              <td>{user.bio}</td>
            </tr>
          </tbody>
        </Table>
      ...
      <Col xs={6}>
        <Button
          ...
          onClick={() => {
            setAreCredentialsBeingUpdated(true);
          }}
        >
          Update&nbsp;Credentials
        </Button>
